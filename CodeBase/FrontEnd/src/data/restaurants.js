...
//   'Url': bar_maps_url, assume it is distance in miles for now
//   'OpenHours': bar_open_hours_to_display
//   'crowd': this_is_dummy_not_in_lambda
// }

//Our Data
export const restaurants_new = [
  { id : 'https://bar-photos-2021.s3.amazonaws.com/ChIJ07ujcMBZwokRkYedKAwgegg.png',
  Name: 'Nobody told me',
  Address : 'manhattan some street',
  ZipCode : '42069',
  Rating : '4',
  PriceLevel : '$$',
  PhoneNumber : '9294928889',
  LGBTQ : 'Yes',
  Url : '0.4 miles',
  OpenHours: '9to5',
  crowd: '4',
  bottomContainers: [
    {
      image: {
        url: "https://img.icons8.com/office/64/000000/wine-glass.png"
      },
      // text: "i see",
    },
  ],
...
export const restaurants_trending = [
  restaurants_new[0],
  restaurants_new[0],
  restaurants_new[0],
  restaurants_new[0],
...
export const restaurants_top_rated = [
  restaurants_new[0],
  restaurants_new[0],
  restaurants_new[0],
  restaurants_new[0],
